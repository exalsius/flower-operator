# flower-operator - AI Agent Guide
...
**Examples:**
- `feat(controller): implement Federation reconciliation logic`
- `fix(webhook): handle nil pointer in validation`
- `docs(readme): add deployment instructions`
- `refactor(api): rename SuperNodePool to Pool`
