...
*/}}
{{- define "flower-operator.fullname" -}}
...
*/}}
{{- define "flower-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "flower-operator.resourceName" -}}
{{- $fullname := include "flower-operator.fullname" .context }}
{{- $suffix := .suffix }}
